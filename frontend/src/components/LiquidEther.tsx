...
interface BaseSimProps {
  cellScale: THREE.Vector2;
  dst: THREE.WebGLRenderTarget;
}

interface AdvectionProps extends BaseSimProps {
  fboSize: THREE.Vector2;
  dt: number;
  src: THREE.WebGLRenderTarget;
}

interface ExternalForceProps extends BaseSimProps {
  cursor_size?: number;
}

interface ViscousProps extends BaseSimProps {
...
interface DivergenceProps extends BaseSimProps {
  boundarySpace?: THREE.Vector2;
  dt: number;
  src: THREE.WebGLRenderTarget;
}

interface PoissonProps extends BaseSimProps {
  boundarySpace?: THREE.Vector2;
  src: THREE.WebGLRenderTarget;
  dst_?: THREE.WebGLRenderTarget;
}

interface PressureProps extends BaseSimProps {
  boundarySpace?: THREE.Vector2;
  dt: number;
...
interface UpdateProps {
  ...
  pressure?: THREE.WebGLRenderTarget | null | undefined;
  iterations_poisson?: number;
}
...
`;
    ...
    class Viscous extends ShaderPass {
      ...
      update(props: UpdateProps = {}): THREE.WebGLRenderTarget | null | undefined {
