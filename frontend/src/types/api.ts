...
export type DatasetStatus = 'uploaded' | 'profiled' | 'validated' | 'cleaned' | 'exported'
...
// Rule types
export type RuleKind = 'missing_data' | 'standardization' | 'value_list' | 'length_range' | 'cross_field' | 'char_restriction' | 'regex' | 'custom'
...
// Execution types
export type ExecutionStatus = 'queued' | 'running' | 'succeeded' | 'failed' | 'partially_succeeded'
...
export interface DataProfileResponse {
  ...
  data_types_summary: Record<string, any>
  missing_values_summary: Record<string, any>
}
